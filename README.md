Hi! This is a C++ implementation of the popular board game Battleship.
...
the whole ship" and then hitting other squares of the same ship would not change 
the result of the game). The display will be through the command-line terminal, 
